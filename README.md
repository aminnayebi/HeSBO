...
Bayesian optimization (BO) has recently emerged as powerful method for optimizing an expensive-to-evaluate black-box objective function.  This repository gives the HesBO
...
## Citation
If you find this code useful, please kindly cite our paper that appears at ICML 2019.
```bash
@inproceedings{HeBO19,
